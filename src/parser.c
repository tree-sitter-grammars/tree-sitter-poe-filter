...
static const TSCharacterRange aux_sym_string_token2_character_set_1[] = {
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (set_contains(aux_sym_string_token2_character_set_1, 680, lookahead)) ADVANCE(1071);
      END_STATE();
    case 2:
      if (lookahead == '\t') SKIP(17);
    ...
    case 4:
      ...
      if (set_contains(aux_sym_string_token2_character_set_1, 680, lookahead)) ADVANCE(1078);
      END_STATE();
    case 5:
      if (lookahead == '!') ADVANCE(996);
      if (lookahead == '"') ADVANCE(1001);
    ...
    case 1071:
      ACCEPT_TOKEN(aux_sym_string_token1);
      if (set_contains(aux_sym_string_token1_character_set_1, 681, lookahead)) ADVANCE(1071);
      END_STATE();
    case 1072:
